YUI.add('moodle-mod_exportquiz-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_exportquiz-questionchooser'
});

M.mod_exportquiz = M.mod_exportquiz || {};
M.mod_exportquiz.init_questionchooser = function() {
    M.mod_exportquiz.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_exportquiz.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_exportquiz-util", "querystring-parse"]});
