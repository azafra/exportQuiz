YUI.add('moodle-mod_exportquiz-exportquizbase', function (Y, NAME) {

/**
 * The exportquizbase class to provide shared functionality.
 *
 * @module moodle-mod_exportquiz-exportquizbase
 */
var QUIZBASENAME = 'mod_exportquiz-exportquizbase';
...
M.mod_exportquiz.exportquizbase = M.mod_exportquiz.exportquizbase || new QUIZBASE();

// Abstract functions that needs to be defined per format (course/format/somename/format.js)
M.mod_exportquiz.edit = M.mod_exportquiz.edit || {};
 ...
 */
M.mod_exportquiz.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
        COURSECONTENT : 'mod-exportquiz-edit-content',
        SECTIONADDMENUS : 'section_add_menus'
    };

    var sectionlist = Y.Node.all('.' + CSS.COURSECONTENT + ' ' + M.mod_exportquiz.edit.get_section_selector(Y));
    // Swap menus.
 ...
 * @return void
 */
M.mod_exportquiz.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
...
*/
M.mod_exportquiz.edit.get_config = function() {
    return {
        container_node : 'ul',
 ...
 */
M.mod_exportquiz.edit.get_section_selector = function() {
    var config = M.mod_exportquiz.edit.get_config();
    if (config.section_node && config.section_class) {
        return config.section_node + '.' + config.section_class;
    }
    Y.log('section_node and section_class are not defined in M.mod_exportquiz.edit.get_config', 'warn', 'moodle-mod_exportquiz-exportquizbase');
    return null;
};
 ...
 *
 * @param {YUI} Y YUI3 instance
 * @return {string} section wrapper selector or M.mod_exportquiz.format.get_section_selector
 * if section_wrapper_node and section_wrapper_class are not defined in the format config.
 */
M.mod_exportquiz.edit.get_section_wrapper = function(Y) {
    var config = M.mod_exportquiz.edit.get_config();
    ...
    return M.mod_exportquiz.edit.get_section_selector(Y);
};
 ...
 */
M.mod_exportquiz.edit.get_containernode = function() {
    var config = M.mod_exportquiz.edit.get_config();
    if (config.container_node) {
        return config.container_node;
    } else {
        Y.log('container_node is not defined in M.mod_exportquiz.edit.get_config', 'warn', 'moodle-mod_exportquiz-exportquizbase');
    }
};
 ...
 */
M.mod_exportquiz.edit.get_containerclass = function() {
    var config = M.mod_exportquiz.edit.get_config();
    if (config.container_class) {
        return config.container_class;
    } else {
        Y.log('container_class is not defined in M.mod_exportquiz.edit.get_config', 'warn', 'moodle-mod_exportquiz-exportquizbase');
    }
};
 ...
 */
M.mod_exportquiz.edit.get_sectionwrappernode = function() {
    var config = M.mod_exportquiz.edit.get_config();
 ...
 */
M.mod_exportquiz.edit.get_sectionwrapperclass = function() {
    var config = M.mod_exportquiz.edit.get_config();
 ...
 */
M.mod_exportquiz.edit.get_sectionnode = function() {
    var config = M.mod_exportquiz.edit.get_config();
    if (config.section_node) {
        return config.section_node;
    } else {
        Y.log('section_node is not defined in M.mod_exportquiz.edit.get_config', 'warn', 'moodle-mod_exportquiz-exportquizbase');
    }
};
 ...
 */
M.mod_exportquiz.edit.get_sectionclass = function() {
    var config = M.mod_exportquiz.edit.get_config();
    if (config.section_class) {
        return config.section_class;
    } else {
        Y.log('section_class is not defined in M.mod_exportquiz.edit.get_config', 'warn', 'moodle-mod_exportquiz-exportquizbase');
    }
};
