YUI.add('moodle-mod_exportquiz-exportquizquestionbank', function (Y, NAME) {
...
/**
 * Add questions from question bank functionality for a popup in exportquiz editing page.
 *
 * @package       mod
...
var CSS = {
        ...
        ADDTOQUIZCONTAINER: 'td.addtoexportquizaction',
...
Y.extend(POPUP, Y.Base, {
    ...
    create_dialogue: function() {
        ...
        config = {
            ...
            postmethod: 'form',
            footerContent: null,
            extraClasses: ['mod_exportquiz_qbank_dialogue']
        };
    ...
    load_content : function(queryString) {
        Y.log('Starting load.', 'debug', 'moodle-mod_exportquiz-exportquizquestionbank');
        this.dialogue.bodyNode.append(this.loadingDiv);

        // If to support old IE.
        if (window.history.replaceState) {
            window.history.replaceState(null, '', M.cfg.wwwroot + '/mod/exportquiz/edit.php' + queryString);
        }

        Y.io(M.cfg.wwwroot + '/mod/exportquiz/questionbank.ajax.php' + queryString, {
            method: 'GET',
            on: {
        ...
        Y.log('Load request sent.', 'debug', 'moodle-mod_exportquiz-exportquizquestionbank');
    },
    ...
    load_done: function(transactionid, response) {
        ...
        Y.log('Load completed.', 'debug', 'moodle-mod_exportquiz-exportquizquestionbank');
    ...
    load_failed: function() {
        Y.log('Load failed.', 'debug', 'moodle-mod_exportquiz-exportquizquestionbank');
    },

    link_clicked: function(e) {
        // Add question to exportquiz. mofify the URL, then let it work as normal.
...
M.mod_exportquiz.exportquizquestionbank = M.mod_exportquiz.exportquizquestionbank || {};
M.mod_exportquiz.exportquizquestionbank.init = function() {
    return new POPUP();
};
