...
/**
 * A column type for the add this question to the exportquiz action.
 *
 * @package       mod
...
class add_action_column extends \core_question\bank\action_column_base {
    ...
    public function init() {
        parent::init();
        $this->stradd = get_string('addtoexportquiz', 'exportquiz');
    }

    public function get_name() {
        return 'addtoexportquizaction';
    }
    ...
    protected function display_content($question, $rowclasses) {
        ...
        $this->print_icon('t/add', $this->stradd, $this->qbank->add_to_exportquiz_url($question->id), $disabled);
    }
