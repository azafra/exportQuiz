...
/**
 * The mod_exportquiz attempt submitted event.
 *
...
/**
 * The mod_exportquiz attempt submitted event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int submitterid: id of submitter (null when trigged by CLI script).
 *      - int exportquizid: (optional) the id of the exportquiz.
 * }
 *
 * @package    mod_exportquiz
 * @since      Moodle 2.6
...
class attempt_submitted extends \core\event\base {
    ...
    protected function init() {
        $this->data['objecttable'] = 'exportquiz_results';
        $this->data['crud'] = 'u';
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has submitted the attempt with id '$this->objectid' for the " .
            "exportquiz with the course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventexportquizattemptsubmitted', 'mod_exportquiz');
    }
    ...
    static public function get_legacy_eventname() {
        return 'exportquiz_attempt_submitted';
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/exportquiz/review.php', array('attempt' => $this->objectid));
    }
    ...
    protected function get_legacy_eventdata() {
        $attempt = $this->get_record_snapshot('exportquiz_attempts', $this->objectid);

        $legacyeventdata = new \stdClass();
        $legacyeventdata->component = 'mod_exportquiz';
        ...
        $legacyeventdata->exportquizid = $attempt->exportquiz;
