...
/**
 * exportquiz statistics report, table for showing statistics of each question in the exportquiz.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class exportquiz_statistics_table extends flexible_table {
    ...
    public function statistics_setup($exportquiz, $cmid, $reporturl, $s) {
        ...
        $columns[] = 'name';
        $headers[] = get_string('questionname', 'exportquiz_statistics');
