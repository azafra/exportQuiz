...
/**
 * Strings for component 'exportquiz_statistics', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['allgroups'] = 'Statistics for all export quiz groups';
...
$string['differentquestions'] = 'Your export quiz groups contain different sets of questions.';
$string['differentsumgrades'] = 'Your export quiz groups have different sums of grades ({$a}). Therefore, the average grade, the median, and the standard deviation cannot be calculated.';
...
$string['errorpowers'] = 'Error fetching data to calculate variance for export quiz grades';
...
$string['negcovar_help'] = 'This question\'s grade for this set of attempts on the export quiz varies in an opposite way to the overall attempt grade. This means overall attempt grade tends to be below average when the grade for this question is above average and vice-versa.

Our equation for effective question weight cannot be calculated in this case. The calculations for effective question weight for other questions in this export quiz are the effective question weight for these questions if the highlighted questions with a negative covariance are given a maximum grade of zero.

If you edit a export quiz and give these question(s) with negative covariance a max grade of zero then the effective question weight of these questions will be zero and the real effective question weight of other questions will be as calculated now.';
...
$string['pluginname'] = 'export Quiz Statistics';
...
$string['exportquizinformation'] = 'export quiz information';
$string['exportquizname'] = 'export quiz name';
$string['exportquizoverallstatistics'] = 'export quiz overall statistics';
$string['exportquizstructureanalysis'] = 'export quiz structure analysis';
...
$string['statistics:componentname'] = 'export quiz statistics report';
$string['statisticsforgroup'] = 'Statistics for group';
$string['statisticshelp'] = 'Help for export quiz statistics';
...
$string['statsfor'] = 'export quiz statistics (for {$a})';
