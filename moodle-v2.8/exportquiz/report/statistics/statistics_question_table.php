...
/**
 * exportquiz statistics report, table for showing statistics about a particular question.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class exportquiz_statistics_question_table extends flexible_table {
    ...
    public function __construct($qid) {
        parent::__construct('mod-exportquiz-report-statistics-question-table' . $qid);
    ...
    public function question_setup($reporturl, $questiondata,
            exportquiz_statistics_response_analyser $responsestats) {
