...
$string['addrandomquestiontoexportquiz'] = 'Adding questions to exportquiz {$a->name} (group {$a->group})';
$string['addrandomquestiontopage'] = 'Add a random question to page {$a}';
$string['addarandomquestion'] = 'questions randomly';
$string['addarandomquestion_help'] = 'Moodle adds a random selection of multiple choice questions (or all-or-nothing multiple-choice questions) to the current Export quiz group. The number of questions added can be set. The questions are chosen from the current question category (and, if selected, its sub-categories).';
$string['addtoexportquiz'] = 'Add to Export quiz';
...
$string['basicideasofexportquiz'] = 'The basic ideas of Export quiz-making';
...
$string['closebeforeopen'] = 'Could not update the Export quiz. You have specified a close date before the open date.';
$string['closestudentview'] = 'Close Student View';
$string['closewindow'] = 'Close Window';
$string['cmmissing'] = 'The course module for the Export quiz with ID {$a} is missing';
$string['configintro'] = 'The values you set here are used as default values for the settings of new Export quizzes.';
$string['configkeepfilesfordays'] = 'Determine how many days the uploaded image files are kept in temporary storage. During this time the image files are available in the Export quiz admin report.';
$string['configonlylocalcategories'] = 'No shared question categories allowed.';
$string['configshuffleanswers'] = 'Shuffle answers';
$string['configshufflequestions'] = 'If you enable this option, then the order of questions in the Export quiz groups will be randomly shuffled each time you re-create the preview in the "Create forms" tab.';;
$string['configshufflewithin'] = 'If you enable this option, the answers of multiple choice questions are shuffled separately for each Export quiz group.';
...
$string['createexportquiz'] = 'Create forms';
...
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the Export quiz.';
$string['decimalplaces'] = 'Decimal places';
$string['decimalplaces_help'] = 'Number of digits that should be shown after the decimal point when displaying grades for the Export quiz.';
...
$string['editgroups'] = 'Edit Export Groups';
$string['editgroupquestions'] = 'Edit group questions';
$string['editingexportquiz'] = 'Editing group questions';
$string['editingexportquiz_help'] = 'When creating an Export quiz, the main concepts are:
*
* The Export quiz, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories';

$string['editexportquiz'] = 'Edit Export quiz';
$string['editingexportquizx'] = 'Edit Export quiz: {$a}';
...
$string['emptygroups'] = 'Some Export quiz groups are empty. Please add some questions.';
...
$string['eventattemptdeleted'] = 'Export quiz attempt deleted';
$string['eventattemptpreviewstarted'] = 'Export quiz attempt preview started';
$string['eventattemptreviewed'] = 'Export quiz attempt reviewed';
$string['eventattemptsummaryviewed'] = 'Export quiz attempt summary viewed';
$string['eventattemptviewed'] = 'Export quiz attempt viewed';
$string['eventdocscreated'] = 'Export quiz question and answer forms created';
$string['eventdocsdeleted'] = 'Export quiz question and answer forms deleted';
$string['eventeditpageviewed'] = 'Export quiz edit page viewed';
$string['eventexportquizattemptsubmitted'] = 'Export quiz attempt submitted';
$string['eventoverridecreated'] = 'Export quiz override created';
$string['eventoverridedeleted'] = 'Export quiz override deleted';
$string['eventoverrideupdated'] = 'Export quiz override updated';
$string['eventparticipantmarked'] = 'Export quiz participant marked manually';
$string['eventquestionmanuallygraded'] = 'Question manually graded';
$string['eventreportviewed'] = 'Export quiz report viewed';
$string['eventresultsregraded'] = 'Export quiz results regraded';
...
$string['formsexist'] = 'Forms already created. Please, removes forms already created';
...
$string['gradeiszero'] = 'Note: The maximum grade for this Export quiz is 0 points!';
$string['gradeswarning'] = 'The question grades have to be numbers!';
$string['gradewarning'] = 'The question grade has to be a number!';
$string['gradingexportquiz'] = 'Grades';
$string['gradingexportquizx'] = 'Grades: {$a}';
...
$string['imagickwarning'] = 'Missing imagick: Ask your system administrator to install the imagemagick library and check the path to the convert binary in your TeX notation filter settings. You cannot improt TIF files without imagemagick!';
...
You can import single scanned image files or several scanned image files in a ZIP-archive. The Export quiz module will process the image files in the background.
...
$string['importisfinished'] = 'Import for Export quiz {$a} is finished.';
$string['importlinkresults'] = 'Link to results: {$a}';
$string['importlinkverify'] = 'Link to verifying: {$a}';
$string['importmailsubject'] = 'Export quiz import notification';
...
$string['modulename_help'] = 'This module allows the teacher to design export quizzes. The questions are kept in the Moodle question bank and can be re-used within courses and even between courses.';
...
<br />This implied manual intervention by a teacher and delayed the publishing of the Export quiz results!</strong>';
...
$string['nocourse'] = 'The course with id {$a->course} that the Export quiz with ID {$a->exportquiz} belongs to is missing.';
...
$string['noexportquiz'] = 'There is no Export quiz with id {$a}!';
...
$string['noquestions'] = 'Some Export quiz groups are empty. Please add some questions.';
...
$string['noreview'] = 'You are not allowed to review this Export quiz';
...
$string['Exportimplementationfor'] = 'Export implementation for';
$string['editExportsettings'] = 'Edit Export settings';
$string['exportquizcloseson'] = 'The review for this Export quiz will close at {$a}';
$string['exportquizisclosed'] = 'Export quiz closed)';
$string['exportquizisclosedwillopen'] = 'Export quiz closed (opens {$a})';
$string['exportquizisopen'] = 'This Export quiz is open';
$string['exportquizisopenwillclose'] = 'Export quiz open (closes {$a})';
$string['exportquizopenedon'] = 'This Export quiz opened at {$a}';
$string['exportquizsettings'] = 'Export settings';
$string['exportquiz:addinstance'] = 'Add an Export quiz';
$string['exportquiz:attempt'] = 'Attempt quizzes';
$string['exportquizcloses'] = 'Export Quiz closes';
$string['exportquiz:createexportquiz'] = 'Create Export quiz forms';
$string['exportquiz:deleteattempts'] = 'Delete Export quiz results';
$string['exportquiz:grade'] = 'Grade Export quizzes manually';
$string['exportquiz:manage'] = 'Manage Export quizzes';
$string['exportquizopens'] = 'Export-Quiz opens';
$string['exportquiz:preview'] = 'Preview Export quizzes';
$string['exportquiz:viewreports'] = 'View Export quiz reports';
$string['exportquiz:view'] = 'View Export quiz information';
$string['exportquizwillopen'] = 'Export-Test opens on {$a}';
...
$string['orderingexportquiz'] = 'Order and paging';
...
$string['page-mod-exportquiz-x'] = 'Any Export quiz page';
$string['page-mod-exportquiz-edit'] = 'Edit Export quiz page';
...
$string['participants_help'] = '<p>Lists of participants are designed for large Export quizzes with many participants. They help the teacher to check which students participated in the quiz and whether all the results were imported correctly.
...
Lists of participants can be downloaded as PDF documents, printed and marked with crosses just like the answer forms of Export quizzes. Afterwards they can be uploaded and the marked students will be marked as present in the database.
...
In this tab you can upload the filled-in lists of participants. You can upload single scanned image files or several scanned image files in a ZIP-archive. The Export quiz module will process the image files in the background.
File names are not relevant but should not contain special characters such as umlauts. Images should be GIFs, PNGs
or TIFs. A resolution between 200 and 300dpi is recommended.</p>';
...
$string['pluginadministration'] = 'Export quiz administration';
$string['point'] = 'point';
...
$string['questionsinthisexportquiz'] = 'Questions in this Export quiz';
$string['questiontextisempty'] = '[Empty question text]';
$string['quizdate'] = 'Date of Export quiz';
...
$string['regradinginfo'] = 'If you change the score for a question, you must regrade the Export quiz to update the participants’ results.';
...
$string['resetexportquizzes'] = 'Reset Export Quiz data';
...
$string['reviewbefore'] = 'Allow review while Export quiz is open';
$string['reviewclosed'] = 'After the Export quiz is closed';
...
$string['showgrades_help'] = 'This option controls whether the maximum grades of the Export quiz questions should be printed on the question sheet.';
...
$string['showtutorial'] = 'Show an Export quiz tutorial to students.';
$string['showtutorial_help'] = 'This option determines whether students can see a tutorial about the basics of Export quizzes.
The tutorial provides information about how to handle the different types of documents in Export quizzes. In an interactive part they learn how to tick their student ID correctly.<br />
<b>Please note:</b><br />
If you set this option to "Yes" but hide the Export quiz the link to the tutorial will not be visible. In this case you can add a link to the tutorial on the course page.';
...
$string['tutorial'] = 'Tutorial for Export quizzes';
$string['type'] = 'Type';
...
$string['upgradingexportquizattempts'] = 'Upgrading Export quiz attempts: Export quiz {$a->done}/{$a->outof} <br/>(Export Quiz ID {$a->info})';
$string['upgradingilogs'] = 'Upgrading scanned pages: scanned page {$a->done}/{$a->outof} <br/>(Export Quiz ID {$a->info})';
...
$string['zerogradewarning'] = 'Warning: Your Export quiz grade is 0.0!';
