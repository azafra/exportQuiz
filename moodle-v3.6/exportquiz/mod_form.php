...
class mod_exportquiz_mod_form extends moodleform_mod {
    ...
    protected function definition() {
        ...
        $mform->addHelpButton('numgroups', 'numbergroups', 'exportquiz');
	...
	//Barajar respuestas
        ...
        $options[EXPORTQUIZ_ODT_FORMAT]  = 'ODT';
        ...
        //Para configurar si se desea mostrar cabecera o no
        $mform->addElement('header', 'headingoptions', get_string("headingoptions", "exportquiz"));
        ...
        //PARA EL CAMPO 1
        $mform->addElement('text', 'campo_libre_1', get_string("campo_libre", "exportquiz", 1), $atributos);
        if (!empty($CFG->formatstringstriptags)) {
            $mform->setType('campo_libre_1', PARAM_TEXT);
        } else {
            $mform->setType('campo_libre_1', PARAM_CLEANHTML);
        }
        $mform->disabledIf('campo_libre_1', 'heading', 'eq', 0);
        $mform->setDefault('campo_libre_1', get_string("user_name", "exportquiz"));
        $mform->addHelpButton('campo_libre_1', 'campo_libre', 'exportquiz');
        
        
        //PARA EL CAMPO 2
        $mform->addElement('text', 'campo_libre_2', get_string("campo_libre", "exportquiz", 2), $atributos);
        if (!empty($CFG->formatstringstriptags)) {
            $mform->setType('campo_libre_2', PARAM_TEXT);
        } else {
            $mform->setType('campo_libre_2', PARAM_CLEANHTML);
        }
        $mform->disabledIf('campo_libre_2', 'heading', 'eq', 0);
        $mform->setDefault('campo_libre_2', get_string("lastname", "exportquiz"));
        $mform->addHelpButton('campo_libre_2', 'campo_libre', 'exportquiz');
        
        
        //PARA EL CAMPO 3
        $mform->addElement('text', 'campo_libre_3', get_string("campo_libre", "exportquiz", 3), $atributos);
        if (!empty($CFG->formatstringstriptags)) {
            $mform->setType('campo_libre_3', PARAM_TEXT);
        } else {
            $mform->setType('campo_libre_3', PARAM_CLEANHTML);
        }
        $mform->disabledIf('campo_libre_3', 'heading', 'eq', 0);
        $mform->setDefault('campo_libre_3', get_string("DNI", "exportquiz"));
        $mform->addHelpButton('campo_libre_3', 'campo_libre', 'exportquiz');
        ...
        // ---------------------
        $this->standard_coursemodule_elements(); //Es obligatorio ponerlo para el core de Moodle, pero lo oculto con javascript
