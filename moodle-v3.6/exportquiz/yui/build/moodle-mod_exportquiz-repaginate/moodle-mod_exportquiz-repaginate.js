YUI.add('moodle-mod_exportquiz-repaginate', function (Y, NAME) {
...
/**
 * Repaginate functionality for a popup in exportquiz editing page.
 *
 * @package       mod
...
M.mod_exportquiz.repaginate = M.mod_exportquiz.repaginate || {};
M.mod_exportquiz.repaginate.init = function() {
    return new POPUP();
};
