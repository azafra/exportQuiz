YUI.add('moodle-mod_exportquiz-randomquestion', function (Y, NAME) {
...
/**
 * Add a random question functionality for a popup in exportquiz editing page.
 *
 * @package       mod
...
M.mod_exportquiz.randomquestion = M.mod_exportquiz.randomquestion || {};
M.mod_exportquiz.randomquestion.init = function() {
    return new POPUP();
};
