 ...
 */
class exportquiz_add_random_form extends moodleform {
    ...
    protected function definition() {
        ...
        $mform->addElement('header', 'categoryheader',
                get_string('addrandomfromcategory', 'exportquiz'));

        $mform->addElement('questioncategory', 'category', get_string('category', 'question'),
                array('contexts' => $usablecontexts, 'top' => false));
        $mform->setDefault('category', $this->_customdata['cat']);

        $mform->addElement('checkbox', 'includesubcategories', '', get_string('recurse', 'exportquiz'));

        $mform->addElement('select', 'numbertoadd', get_string('randomnumber', 'exportquiz'),
