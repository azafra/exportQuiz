...
/**
 * The mod_exportquiz report viewed event class.
 *
...
class report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportviewed', 'mod_exportquiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the report '" . s($this->other['reportname']) .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'exportquiz', 'report', 'report.php?id=' . $this->contextinstanceid . '&mode=' .
