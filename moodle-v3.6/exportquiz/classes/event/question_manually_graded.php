...
/**
 * The mod_exportquiz question manually graded event class.
 *
...
class question_manually_graded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventquestionmanuallygraded', 'mod_exportquiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' manually graded the question with id '$this->objectid' for the result " .
            "with id '{$this->other['resultid']}' in the exportquiz with the course module id '$this->contextinstanceid'.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/exportquiz/comment.php', array('resultid' => $this->other['resultid'],
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'exportquiz', 'manualgrade', 'comment.php?resultid=' . $this->other['resultid'] .
            '&slot=' . $this->other['slot'], $this->other['exportquizid'], $this->contextinstanceid);
    }
