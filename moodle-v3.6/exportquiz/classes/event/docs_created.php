...
/**
 * The mod_exportquiz documents creation event class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class docs_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventdocscreated', 'mod_exportquiz');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'exportquiz', 'createpdfs', 'mod/exportquiz/createquiz.php?id=' .
